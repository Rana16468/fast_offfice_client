...
const SpecificCategorieDetails = ({
  ...
  return (
            ...
            <div
              ...
              <div className="bg-blue-500 text-white text-center py-2">
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  {/* Add Icon */}
                  <Link to={`/fast_office_product/add_product_details?id=${office?._id}`}
                  ...
                  {/* Update Icon */}
                  <button onClick={() => handelUpdateCategorie(office?._id)}
                    className="flex items-center px-4 py-2 font-semibold bg-blue-600 hover:bg-blue-700 rounded-md transition-colors duration-200">
    ...
    <UpdateSpecificCategorie officeCategorieId={officeCategorieId}  refetch={ refetch}/>
