...
const DeleteAccount = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-cover bg-center py-10 mt-16"
      style={{
        backgroundImage: `url('https://t4.ftcdn.net/jpg/06/98/63/49/360_F_698634901_ZiquGePY1Ay8PrO8foPZQ0AQSi8cL9ry.jpg')`,
      }}
    >
