...
const Profile = () => {
  ...
  useEffect(() => {
    try {
      ...
      toast.error(`Error parsing device info:${error?.message}`)
    }
  }, []);
    ...
    queryFn: async () => {
      try {
        const res = await fetch(
          `${import.meta.env.VITE_COMMON_ROOT}/api/v1/user/myprofile`,
          {
            method: "GET",
            headers: {
  ...
  const handleProfileSubmit = async (event) => {
    ...
    if (updateInfo) {
      updateUserProfile(updateInfo)
        .then(() => {
          fetch(
            `${import.meta.env.VITE_COMMON_ROOT}/api/v1/auth/update_profile`,
            {
              method: "PATCH",
              headers: {
        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-2">
          <div className="bg-white/50 shadow-lg rounded-lg p-6">
            ...
            <ul className="divide-y divide-gray-200">
              ...
              <li className="py-3 flex justify-between items-center">
                <span className="flex items-center space-x-2">
                  <RiTimeZoneFill className="text-gray-500" />
        ...
        <div className="bg-white/70 shadow-md rounded-lg p-6 grid gap-4 sm:grid-cols-1 md:grid-cols-2 mt-2">
            ...
            <div>
              ...
              <ul className="divide-y divide-gray-200">
                ...
                <li className="py-3 flex justify-between items-center">
                  <span className="flex items-center space-x-2">
                    <VscAccount className="text-yellow-500" />
            ...
            <div>
              ...
              <ul className="divide-y divide-gray-200">
                ...
                <li className="py-3 flex justify-between items-center">
                  <span className="flex items-center space-x-2">
                    <LiaAddressCardSolid className="text-gray-500" />
                    <strong>District:</strong>
                  </span>
                ...
                <li className="py-3 flex justify-between items-center">
                  <span className="flex items-center space-x-2">
                    <SiCriticalrole className="text-gray-500" />
